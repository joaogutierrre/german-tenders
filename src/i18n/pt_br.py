...
STRINGS: dict[str, str] = {
    ...
    "welcome.menu.orgs_list": "Listar todas as organizacoes e seus detalhes",
    ...
    "help.cmd.orgs_list": "Listar todas as organizacoes com seus detalhes.",
